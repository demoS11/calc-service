...
func (c *calculatorClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateReply, error) {
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *CalculateRequest) (*CalculateReply, error) {
